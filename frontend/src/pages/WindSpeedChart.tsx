...
function WindSpeedPage({ latLong, weatherV3 }: IPageProps) {
  ...
  return (
    <div className={`relative overflow-auto text-white h-screen`} >
      <div className={`mx-12 mt-8 flex items-center justify-between ${backgroundColor} rounded-t-lg p-4`}>
        <div className='flex items-center '>
          <img src="https://bmcdn.nl/assets/weather-icons/v2.0/line/wind.svg" className='w-16 h-16' />
          <div className=' text-3xl '>Wind @ {latLong.description}</div>
        </div>
      ...
      {maxWindGustIndex && minWindGustIndex && weatherV3 &&
        <div className={`mx-12 py-4 px-8 ${backgroundColor} `} >
